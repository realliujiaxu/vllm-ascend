...
static ge::graphStatus CheckAttrParams(const gert::TilingContext *context, MegaMoeConfig &config, const char *nodeName)
{
    ...
    if (refWeightDataType != weightOneDesc->GetDataType()) {
        std::string weightDtypeErrMsg = std::string("The dtype of weightOne (") +
                                        ...
                                        ") must match dispatch quant dtype (" + ge::TypeUtils::DataTypeToSerialString(refWeightDataType) +
                                           ...
                                           const char *nodeName)
{
    ...
    OP_TILING_CHECK(topkIdsDesc->GetDataType() != ge::DT_INT32,
                    OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(nodeName, "topkIds",
                                                          ge::TypeUtils::DataTypeToSerialString(topkIdsDesc->GetDataType()).c_str(),
    ...
    OP_TILING_CHECK(
        ...
        OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
            nodeName, "weightOne", ge::TypeUtils::DataTypeToSerialString(weightOneDesc->GetDataType()).c_str(),
    ...
    OP_TILING_CHECK(
        ...
        OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
            nodeName, "weightTwo", ge::TypeUtils::DataTypeToSerialString(weightTwoDesc->GetDataType()).c_str(),
    ...
    OP_TILING_CHECK(
        ...
        OP_LOGE_FOR_INVALID_DTYPES_WITH_REASON(nodeName, "weightOne, weightTwo",
                                               (std::string("[") + ge::TypeUtils::DataTypeToSerialString(weightOneDesc->GetDataType()) +
                                                ", " + ge::TypeUtils::DataTypeToSerialString(weightTwoDesc->GetDataType()) + "]")
                                                   .c_str(),
    ...
    OP_TILING_CHECK(weightScalesOneDesc->GetDataType() != ge::DT_FLOAT8_E8M0,
                    OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
                        nodeName, "weightScalesOne", ge::TypeUtils::DataTypeToSerialString(weightScalesOneDesc->GetDataType()).c_str(),
                        "The dtype of weightScalesOne must be DT_FLOAT8_E8M0."),
                    return ge::GRAPH_FAILED);

    OP_TILING_CHECK(weightScalesTwoDesc->GetDataType() != ge::DT_FLOAT8_E8M0,
                    OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
                        nodeName, "weightScalesTwo", ge::TypeUtils::DataTypeToSerialString(weightScalesTwoDesc->GetDataType()).c_str(),
    ...
    OP_TILING_CHECK(expertTokenNumsDesc->GetDataType() != ge::DT_INT32,
                    OP_LOGE_FOR_INVALID_DTYPE_WITH_REASON(
                        nodeName, "expertTokenNums", ge::TypeUtils::DataTypeToSerialString(expertTokenNumsDesc->GetDataType()).c_str(),
