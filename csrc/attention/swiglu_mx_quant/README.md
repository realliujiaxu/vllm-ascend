...
| 调用方式 | 调用样例 | 说明 |
| :------- | :------- | :--- |
| aclnn调用 | [test_aclnn_swiglu_mx_quant](./examples/test_swiglu_mx_quant.cpp) | 通过[aclnnVllmAscendSwigluMxQuant](./docs/aclnnVllmAscendSwigluMxQuant.md)接口方式调用VllmAscendSwigluMxQuant算子。 |
