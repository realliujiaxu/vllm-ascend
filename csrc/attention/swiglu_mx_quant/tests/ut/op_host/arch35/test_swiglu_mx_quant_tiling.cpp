...
TEST_F(SwigluMxQuantTilingTest, test_tiling_swiglu_mode_1_no_interleave)
{
    ge::DataType xDtype = ge::DT_FLOAT16;
    ge::DataType yDtype = ge::DT_FLOAT8_E4M3FN;
    ge::DataType mxscaleDtype = ge::DT_FLOAT8_E8M0;
    gert::StorageShape xShape = {{1, 1, 128}, {1, 1, 128}};
    gert::StorageShape yShape = {{1, 1, 64}, {1, 1, 64}};
    gert::StorageShape mxscaleShape = {{1, 1, 1, 2}, {1, 1, 1, 2}};
    ExecuteTestCase(
        xDtype, yDtype, mxscaleDtype, xShape, yShape, mxscaleShape,
        -1, true, 1, 7.0f, 1.702f, 1.0f, 0, -1, 36, "rint", 0, 0.0f,
        ge::GRAPH_SUCCESS);
}

TEST_F(SwigluMxQuantTilingTest, test_tiling_swiglu_mode_1_invalid_clamp_limit)
{
    ge::DataType xDtype = ge::DT_FLOAT16;
    ge::DataType yDtype = ge::DT_FLOAT8_E4M3FN;
    ge::DataType mxscaleDtype = ge::DT_FLOAT8_E8M0;
    ...
    ExecuteTestCase(
        xDtype, yDtype, mxscaleDtype, xShape, yShape, mxscaleShape,
        -1, true, 1, 0.0f, 1.702f, 1.0f, 0, -1, 36, "rint", 0, 0.0f,
        ge::GRAPH_FAILED);
}
